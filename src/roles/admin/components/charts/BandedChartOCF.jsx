    ...
    return (
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          <span style={{ fontSize: 12, color: "#4b5563" }}>Overclaim Rate:</span>
...
const renderLegend = () => {
  const items = [
    { value: 'Target Range (0% - 15%)', color: '#E5E7EB', type: 'square' },
    { value: 'Order Cancellation Freq.', color: '#10B981', type: 'line' }
  ];
