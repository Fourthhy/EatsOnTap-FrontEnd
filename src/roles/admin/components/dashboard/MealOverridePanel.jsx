        ...
        <div style={{ backgroundColor: 'white', borderRadius: '12px', border: '1px solid #E5E7EB', padding: '20px', boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.05)', transition: 'all 0.3s ease' }}>
            ...
            >
                <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                    <div style={{ backgroundColor: '#FEF2F2', padding: '8px', borderRadius: '8px', color: '#DC2626' }}>
                        <CalendarX2 size={20} />
                    </div>
                    <div>
                        <h3 style={{ fontSize: '16px', fontWeight: 700, color: '#1F2937', margin: 0, fontFamily: 'geist, sans-serif' }}>Schedule Suspensions</h3>
                        <p style={{ fontSize: '12px', color: '#6B7280', margin: 0 }}>Optional: Block claims for specific dates.</p>
                    </div>
                </div>
