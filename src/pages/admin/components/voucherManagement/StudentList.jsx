                    ...
                    <table className="w-full text-left border-collapse">
                        <thead className="bg-gray-50/50 h-[5vh]">
                            <tr>
                                ...
                                <th style={{ fontSize: 12 }} className="font-geist py-3 px-6 font-medium text-gray-500">Student ID</th>
                                {/* Dynamic Header */}
                                ...
                                <th style={{ fontSize: 12 }} className="font-geist py-3 px-6 font-medium text-gray-500">Link</th>
                        ...
                        <tbody className="divide-y divide-gray-100">
                            {currentData.map((student, index) => (
                                <tr key={student.id} className="hover:bg-gray-50/80 transition-colors group">
                                    ...
                                    <td style={{ fontSize: 12 }} className="font-geist py-4 px-6 text-black">{student.studentId}</td>
                                    <td style={{ fontSize: 12 }} className="font-geist py-4 px-6 text-black">{student.program}</td>
                                    <td style={{ fontSize: 12 }} className="font-geist py-4 px-6 text-blue-600 underline cursor-pointer"></td> {/* Empty Content */}
                                    <td style={{ fontSize: 12 }} className="font-geist py-4 px-6 text-black text-center">{student.type}</td>
