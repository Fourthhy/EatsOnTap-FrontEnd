...
export default function ChancellorDashboard() {
    ...
    const claimData = [
        { title: "Total Waived Students", value: 10, subtitle: "10 students don't want to claim today" },
        { title: "Students Claimed Today", value: 100, subtitle: "both free lunch and food item" },
        { title: "Total Eligible Students", value: 100, subtitle: "43 sections | 12 programs & year" },
    ]
                ...
                <div className="h-full w-full">
                    <div
                        ...
                        <div className="w-full h-auto flex flex-col gap-4">
                            <div className="grid grid-cols-7 gap-4">
                                <div className="h-full col-span-2">
                                    <CustomStatsCard title={"Daily Virtual Credit Used"} value={95} isPercentage={true} subtitle={"₱60,000 claimed out of ₱65,000 allotted"} />
                                </div>
                                <div className="col-span-5">
                                    <StatsCardGroup
                                        cardGroupTitle={"Meal Claim Status"}
                                        primaryData={claimData}
                        ...
                        <div className="h-auto flex flex-col gap-4">
                            <div>
                                <EventsPanel events={upcomingEvents} isHyerlink={false} canViewAll={false} />
                            </div>
                            <div>
                                <MealAllowanceCard />
                            </div>
