...
import BSAISlogo from "/MealClaim/BSAIS-logo.svg";

function BSAISMealCLaim() {
  const sampleStudentName = "Doe, J***";
  const sampleProgram = "BSAIS 4";
      ...
      <div className="flex items-center justify-center flex-grow">
        <div
          style={{
            width: "765px",
            height: "461px",
            backgroundImage: "url('/MealClaim/BSA-card.svg')",
