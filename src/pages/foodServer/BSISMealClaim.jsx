...
import BSISlogo from "/MealClaim/BSIS-logo.svg";

function BSISMealClaim() {
  const sampleStudentName = "Doe, J***";
  const sampleProgram = "BSIS 4";
  ...
  return (
    <div className="flex flex-col  w-full h-screen bg-[url(/MealClaim/BGClaimed.svg)] bg-cover bg-no-repeat bg-center">
      ...
      <p className="text-[18px] font-tolkien">LA VERDAD CHRISTIAN COLLEGE, INC.</p>
      <p className="text-[12px]">MacArthur Highway, Sampaloc, Apalit, Pampanga 2016</p>
      </div>
      <div className="flex items-center justify-center flex-grow">
        <div
          style={{
            width: "765px",
            height: "461px",
            backgroundImage: "url('/MealClaim/BSIS-card.svg')",
          ...
          <div className="w-full h-full">
            <div className="h-[90%] w-full grid grid-cols-3">
              ...
              <div className="w-full h-full flex items-center justify-end" >
                <img src={BSISlogo} alt="BSIS logo" className="w-[180px]" style={{marginRight: '10px'}}/>
              </div>
            </div>
            <div
